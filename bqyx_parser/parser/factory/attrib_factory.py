...
from bqyx_parser.parser.attrib.abstract import AttribParser
from bqyx_parser.parser.attrib.default_parser import DefaultAttribParser
...
class AttribParserRegistry:
    ...
    def register_parser(self, parser: AttribParser, condition: Optional[Callable[[etree._Element], bool]] = None, priority: int = 0):
        """
        注册属性解析器
    ...
    def get_parser(self, child: etree._Element) -> AttribParser:
        """
        根据元素获取合适的属性解析器
    ...
    def parse(self, child: etree._Element, result: Dict[str, Any]) -> None:
        """
