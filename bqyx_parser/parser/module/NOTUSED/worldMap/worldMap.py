...
if __name__ == "__main__":
    ...
    xml_path = xml_dir / "worldMap.xml"
    output_path = out_put_dir / "worldMap.json"
    resource_path = Path(r"D:\bqyx\rs\resource\worldMap\worldMap.json")

    logger.info("解析 %s", xml_path)
    result = parse_element_by_factory(load_xml(xml_path), create_worldMap_factory())
