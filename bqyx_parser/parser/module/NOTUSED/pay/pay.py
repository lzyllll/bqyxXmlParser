...
if __name__ == "__main__":
    ...
    output_path = out_put_dir / "payData.json"
    resource_path = Path(r"D:\bqyx\rs\resource\pay\payData.json")

    logger.info("解析 %s", xml_path)
    result = parse_element_by_factory(load_xml(xml_path), create_pay_factory())
