...
if __name__ == "__main__":
    ...
    resource_path = Path(r"D:\bqyx\rs\resource\skin\armsSkin.json")

    logger.info("解析 %s", xml_path)
    result = parse_element_by_factory(load_xml(xml_path), create_armsSkin_factory())
