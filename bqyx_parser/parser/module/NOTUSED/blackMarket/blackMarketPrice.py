...
def create_blackMarketPrice_factory():
...
if __name__ == "__main__":
    ...
    xml_path = xml_dir / "blackMarketPrice.xml"
    output_path = out_put_dir / "blackMarketPrice.json"
    resource_path = Path(r"D:\bqyx\rs\resource\blackMarket\blackMarketPrice.json")

    logger.info("解析 %s", xml_path)
    result = parse_element_by_factory(load_xml(xml_path), create_blackMarketPrice_factory())
