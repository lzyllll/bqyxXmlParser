...
def create_blackEquip_factory():
    ...
    factory.attrib_registry.register_name("resolveB", NameAttribParser())
    factory.attrib_registry.register_name("composeProConstB", NameAttribParser())
    factory.attrib_registry.register_name("chipNum", NameAttribParser())
    return factory
...
def run(xml_dir: Path | None = None, out_put_dir: Path | None = None) -> None:
    ...
    xml_path = xml_dir / "blackEquip.xml"
    output_path = out_put_dir / "blackEquip.json"
